    ...
    <div class="container mt-5 pt-5">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 text-center bloggs" id=" ">
                ...
                <h1> Aastha Interior Design Blogs </h1>
        ...
        ?>
            ...
            <div class=col-md-4>
                ...
                <div class="card" style="width: 100%;">
                    <img src="<?php echo site_Url ?>images/<?php echo $res['img'] ?>" class="card-img-top" alt="..."
                        style="height:267px;">
                    <div class="card-body" id="butts">
                        <h5 class="card-title"> <a
                                href="<?php echo site_Url; ?>blog/<?php echo $res['slug'] ?>"><?php echo $res['title'] ?></a>
                        </h5>
                        <p class="card-text"><?php echo substr(strip_tags($res['content']), 0, 100) . "...";?></p>
                        <button type="button" class="btn"><a href="<?php echo site_Url; ?>blog/<?php echo $res['slug'] ?>">Read More</a></button>
                        <ul class="d-flex pb-3 bloggs-list" style="list-style: none; padding:0">
                            <li>
                                <a href="
                      https://www.facebook.com/AsthaDesignOffical" target="_blank"> <svg
                                        ...
                                        class="bi bi-facebook fb" viewBox="0 0 16 16">
                                        <path
                            ...
                            <li>
                                <a href="https://twitter.com/aasthadesign" target="_blank"> <svg
                                        xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor"
                                        class="bi bi-twitter twi" viewBox="0 0 16 16">
                                        <path
                            ...
                            <li>
                                <a href="https://www.instagram.com/aasthadesignofficial/ " target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor"
                                        class="bi bi-instagram insta" viewBox="0 0 16 16">
                                        <path
                            ...
                            <li>
                                <a href="https://www.youtube.com/channel/UCORC5XiJMNMAgBNdlkXVUzA" target="_blank"> <svg
                                        xmlns="http://www.w3.org/2000/svg" width="29" height="23" fill="currentColor"
                                        class="bi bi-youtube you" viewBox="0 0 16 16">
                                        <path

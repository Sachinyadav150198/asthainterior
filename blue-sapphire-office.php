...
<head>
  ...
  <!-- <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&family=Montserrat:ital,wght@1,700&family=Roboto:ital,wght@0,400;1,300&display=swap" rel="stylesheet">
-->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link
...
<body>
  ...
  <div class="container-fluid mt-5 pt-5" id="nx-one">

    <div class="row pt-5 mt-5">


        <h1 class="text-center pt-3">Blue Sapphire Office</h1>
        <div class="container">
  ...
  <!-- section1 -->
  <div class="container mt-5 pt-5" id="kit">
    ...
    <div class="col-md-8">
      ...
      <img src="./images/blue-sapphireimg4.jpg" alt="" style="width:100%;height:500px">
      </div>

    

      <p class="mt-4 text-justify">There are many variations of passages of Lorem Ipsum available, but the majority have
        ...
        therefore always free from repetition, injected humour, or non-characteristic combined with a handful of model
        sentence structures words etc.</p>



      <div class="row mt-5 p-5 " id="kb">
        ...
        <div class="col-md-3">
          ...
          <div>
            <img src="./images/blue-sapphireimg2.jpg" alt="" style="width:100%;height:130px;">
          </div>
      ...
      <div class="row pt-5">
        <div class="col-md-6">
          ...
          <div data-aos="fade-right">
            <div class="contain">
              <img src="./images/blue-sapphireimg1.jpg" alt="Avatar" class="image">
              <div class="overlay">
        ...
        <div class="col-md-6">
          ...
          <div data-aos="fade-left">
            <div class="contain">
              <img src="./images/blue-sapphireimg3.jpg" alt="Avatar" class="image">
              <div class="overlay">
                <!-- <div class="text">Hello World</div> -->
              </div>
            </div>
      ...
      <div class="pt-5 pb-5">
        <h1>Advanced Benefits</h1>

        <p class="pt-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in
          some form, by injected humour, or randomised words which don’t look even slightly believable. If you are going
          to use a passage of Lorem Ipsum, you need to be sure there isn’t anything embarrassing hidden in the middle of
          ...
          Ipsum is therefore always free from repetition, injected humour, or non-characteristic combined with a handful
          of model sentence structures words etc.</p>
      </div>
    ...
    <div class="col-md-4">
      <div id="next-section">
       ...
       <div class="pt-3">
          ...
          <!--  -->
               <div class="col-md-12 d-flex uni-but p-3">
                 
                <div class="col-md-9">
               <a href="./interior">Interior Design</a>
                </div>
               <div class="col-md-3"id="svg-res">
               <svg xmlns="http://www.w3.org/2000/svg" width="29" height="21" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
               ...
               <div class="col-md-12 d-flex uni-but p-3 mt-3">
                 
                 <div class="col-md-9">
                <a href="./civil-work">Civil Work</a>
                 </div>
                <div class="col-md-3"id="svg-res2">
                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="21" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
             <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
           </svg></div>
                ...
                <div class="col-md-12 d-flex uni-but p-3 mt-3">
                 ...
                 <div class="col-md-9">
                <a href="./3d-modelling">3D Modelling</a>
                 </div>
                <div class="col-md-3"id="svg-res3">
                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="21" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
             <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
           </svg></div>
                ...
                <div class="col-md-12 d-flex uni-but p-3 mt-3">
                 ...
                 <div class="col-md-9">
                <a href="./layout-design">LayOut Design</a>
                 </div>
                <div class="col-md-3"id="svg-res1">
                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="21" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
             <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
           </svg></div>
      ...
      <h3>
        Do You Need Any Help?</h3>

        <p class="pt-4">My job is to help professionals to achieve their industrial goals whilst having adequate protection along the way.</p>



        <div class="" id="butts">
          <a href="./contact-us"> <button type="button" class="btn p-2 m-1 px-3">Get in touch</button></a>
         </div>

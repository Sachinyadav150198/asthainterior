...
<body>
  ...
  <div class="container-fluid mt-5 pt-5" id="int">
    ...
    <div class="row pt-5 mt-5">
        ...
        <h1 class="text-center pt-3">Interior Design</h1>
        <div class="container">
  ...
  <div class="container mt-5 pt-5" id="kit">
    ...
    <div class="col-md-8">
      ...
      <img src="./images/new-img11.jpeg" alt="" style="width:100%;height:500px">
      </div>
      ...
      <div class="row mt-5 p-5 " id="kb">
        ...
        <div class="col-md-3">
          ...
          <div>
            <img src="./images/new-img6.jpeg" alt="" style="width:100%;height:130px;">
          </div>
      ...
      <div class="row pt-5">
        <div class="col-md-6">
          ...
          <div data-aos="fade-right">
            <div class="contain">
              <img src="./images/new-img1.jpeg" alt="Avatar" class="image">
              <div class="overlay">
        ...
        <div class="col-md-6">
          ...
          <div data-aos="fade-left">
            <div class="contain">
              <img src="./images/new-img2.jpeg" alt="Avatar" class="image">
              <div class="overlay">
                <!-- <div class="text">Hello World</div> -->
              </div>
            </div>

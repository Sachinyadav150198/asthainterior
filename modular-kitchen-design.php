...
<body>
  ...
  <div class="container-fluid mt-5 pt-5" id="kitchs">

    <div class="row pt-5 mt-5">


        <h1 class="text-center pt-3">Kitchen Design</h1>
        <div class="container">
  ...
  <div class="container mt-5 pt-5" id="kit">
    ...
    <div class="col-md-8">
      ...
      <img src="./images/new-img6.jpeg" alt="" style="width:100%;height:500px">
      ...
      <div class="row pt-5">
        <div class="col-md-6">
          ...
          <div>
            <img src="./images/new-img2.jpeg" alt="" width="100%">
          </div>
           </div>
        </div>
        <div class="col-md-6">
          ...
          <div>
            <img src="./images/new-img7.jpeg" alt="" width="100%">
          </div>
